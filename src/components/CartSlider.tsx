        ...
        {items.length > 0 && (
          <div className="p-4 border-t border-border space-y-3">
            ...
            <div className="flex gap-2">
              <Link to="/cart" onClick={() => setSliderOpen(false)} className="flex-1 btn-outline-gold text-xs text-center py-2.5">
                View Cart
              </Link>
              <Link to="/checkout" onClick={() => setSliderOpen(false)} className="flex-1 btn-gold text-xs text-center py-2.5">
                Checkout
              </Link>
            </div>
          </div>
